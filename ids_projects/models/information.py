...
class Information(BaseMetadata):
    """ """
    name = 'idsvc.information'
    ...
    def information_type(self):
        return self.value.get('information_type')

    @property
    def title(self):
        title = self.value.get('information_type')
        return title.title()
    ...
    def delete(self):
        ...
        logger.debug('deleting information entity: %s - %s' % (self.title, self.uuid))
